...
public class AddProductController implements Initializable {
    ...
    /**
     * Add Product Controller Constructor. Takes in an inventory object.
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        // Populate the top table view by getting all the parts in inventory.
        ...
        // Loop through all products and set newID equal to the highest product ID.
        // Finally if newID is greater than the initialization value (a product exists), increment newID by 1
        newId = -1;
        ...
        try {
            ...
            if(productMin <= productMax) {
                ...
                if ((productMin <= productStock) && (productStock <= productMax)) {
                    // Create new product, and add associated parts to the product.
